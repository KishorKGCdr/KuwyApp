...
<title>loan_eligibility_forecast</title>
...
<body onload="getYear()">
	...
	<div class="container">
		...
		<div class=" col-sm-6 mainFormDiv">
			...
			<form action="savingData.lef" method="post" role="form"
				...
				<div class="vehicle_details">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="btn btn-primary btn-block">
								<input type="hidden" id="usedVehicle" name="usedVehicle"
									checked="checked" value="1"><label for="usedVehicle">Used</label>
							</div>
						</div>
					</div>
							...
							<div class="btn-group btn-group-justified btn-group-toggle "
								...
								<div class="btn btn-primary ">
									<input type="radio" name="vehicleType" id="vehTypeTexi"
										style="" value="2"><label
										onlclick="vehicleTypeFunc('texi')">Taxi</label>
								</div>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="btn btn-primary btn-block">
								<input type="radio" id="loanType" name="purchased"
	...
	<script type="text/javascript">
		function getYear() {
			...
			request.open('GET', './api/v1/vehicle/getAllDistYear.do', true);
		...
		function changeYear() {
			...
			request.open('GET',
					'.api/v1/vehicle/getAllDistBrandByYear.do?mfgYear=' + mfgYear, true);
			request.onload = function() {
				// Begin accessing JSON data here
				var data = JSON.parse(this.response)
		...
		function changeBrand() {
			...
			request.open('GET', '.api/v1/vehicle/getAllDistinctModelByBrandNYear.do?mfgYear='
		...
		function changeModel() {
			...
			request.open('GET',
					'.api/v1/vehicle/getAllDistinctVariantByBrandNYearNModel.do?mfgYear='
